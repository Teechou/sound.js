...
var soundUrlArr=["http://sonicam.co/360videotest/sounds/s1.wav","http://sonicam.co/360videotest/sounds/s2.wav","http://sonicam.co/360videotest/sounds/s3.wav","http://sonicam.co/360videotest/sounds/s4.wav","sounds/s5.aac",
"sounds/s6.aac"]
...
var soundBuffer, sound, soundBuffer1,soundBuffer2;
	        ...
	        if((pausePoint>=totalTime)||gap<500){
	        	sound.stop(0);
                    ...
                    if(pausePoint<soundBuffer1.duration)
                    {
                        ...
                        if(pausePoint>=(soundBuffer1.duration+soundBuffer2.duration+soundBuffer3.duration-2))
                        {
                            console.log(soundBuffer);
                            console.log(soundBuffer4);
                            console.log('执行')
                            if(soundBuffer4 == undefined){
                                console.log('执行00')
                                krpano.call(' plugin[video].pause(); ');
