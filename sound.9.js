...
function loadSample(url, doAfterLoading) {
    ...
    setTimeout(function(){
        if(!f1){
            // alert('Loading failed, please refresh try again!')
        }
    },30000)
...
function mouseActionLocal(angleXY) {
    ...
    function playToggles(seek){
        ...
        totalDrt=(soundBuffer9&&(drt1+drt2+drt3+drt4+drt5+drt6+drt7+drt8+drt9))||(soundBuffer8&&(drt1+drt2+drt3+drt4+drt5+drt6+drt7+drt8))||(soundBuffer7&&(drt1+drt2+drt3+drt4+drt5+drt6+drt7))||(soundBuffer6&&(drt1+drt2+drt3+drt4+drt5+drt6))||(soundBuffer5&&(drt1+drt2+drt3+drt4+drt5))||(soundBuffer4&&(drt1+drt2+drt3+drt4))||(soundBuffer3&&(drt1+drt2+drt3))||(soundBuffer2&&(drt1+drt2))||(soundBuffer1&&drt1)
        console.log(totalDrt+'...'+seek);
        if(totalDrt<=seek)
        {
        ...
        // console.log(pausedFlag);
        if(oLoading.style.display=='block'||totalDrt<=seek){
